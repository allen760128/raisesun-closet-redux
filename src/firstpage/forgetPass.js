...
import {
    handleForget, handleForgetCancel, handleIdforget,
    handleEmailforget, handleForgetsubmit, handleClear
...
const ForgetPass = (props) => {
    ...
    const forgetcancel = (e) => {
        dispatch(handleClear());
        dispatch(handleForgetCancel(e))
    }
                ...
                <div className={style.innerWrap}>
                    ...
                    <form action="result.php" method="post" onSubmit={forgetSubmit}>
                        ...
                        <div className={style.buttonWrap}>
                            ...
                            <input type='button' value='取消' onClick={(e) => { forgetcancel(e) }} />
                        </div>
                    </form>
                </div>
            </div>
